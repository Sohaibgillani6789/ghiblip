...
export default function SpiritedAwayLandscapePage() {
        ...
        >
            <div
                style={{
                    ...
                    backgroundImage: "url('/kds.webp')", backgroundSize: "cover", backgroundPosition: "center top",
            ...
            <div
                style={{
                    position: "absolute", top: 0, left: 0, width: "100%", height: "100%",
                    background: "linear-gradient(to top, #000 %, rgba(0,0,0,0.15) 20%, rgba(0,0,0,0.3) 5%, transparent 100%)",
                    zIndex: 1,
                }}
            />
            <button
