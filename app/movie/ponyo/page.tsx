...
export default function TotoroPage() {
        ...
        >
            <div
                style={{
                    ...
                    backgroundImage: "url('/p1.webp')", backgroundSize: "cover", backgroundPosition: "center top",
            ...
            <div
                style={{
                    position: "absolute", top: 0, left: 0, width: "100%", height: "100%",
                    background: "linear-gradient(to top, #000 0%, rgba(0,0,0,0.85) 2%, rgba(0,0,0,0.3), transparent 100%)",
                    zIndex: 1,
                }}
            />
            <button
            ...
            >
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "2rem", marginBottom: "2.5rem", fontSize: "0.95rem", color: "#ccc", fontFamily: "sans-serif" }}>
                    <span style={{ color: "#46d369", fontWeight: 700 }}>8.1/10</span>
                    <span>1988</span>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "1rem", fontSize: "0.85rem", color: "#aaa", fontFamily: "sans-serif" }}>
                    <div><span style={{ color: "#777" }}>Genres: </span>Animation, Family, Fantasy</div>
                </div>
            </div>
        </div>
    );
